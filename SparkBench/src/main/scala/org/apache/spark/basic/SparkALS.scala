...
package org.apache.spark.basic
...
object SparkALS {
  ...
  def main(args: Array[String]): Unit = {
    ...
    if (args.length < 5){
      System.err.println(s" 5 arguments Movies, Users, Features, Iteration, input_data_slice ")
      System.exit(1)
    }
    ...
    options.toArray match {
      case Array(m, u, f, iters, slices_) =>
        ...
        slices = slices_.getOrElse("16").toInt
      case _ =>
    ...
    println(s"Running with M=$M, U=$U, F=$F, iters=$ITERATIONS, slice=$slices ")
